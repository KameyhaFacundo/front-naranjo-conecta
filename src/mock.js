...
export const mockServicios = [
  {
    ...
    zona: 'Centro',
    foto_url: '/images/servicio-electricista.png',
    ...ubicacion(1),
    activo: true,
  ...
  },
  {
    ...
    zona: 'RP321',
    foto_url: '/images/servicio-plomero.png',
    ...ubicacion(2),
    activo: true,
  ...
  },
  {
    ...
    zona: 'Barrio San Jorge',
    foto_url: '/images/servicio-albanil.png',
    ...ubicacion(3),
    activo: true,
  ...
  },
  {
    ...
    zona: 'Centro',
    foto_url: '/images/servicio-profesora.png',
    ...ubicacion(4),
    activo: true,
  ...
  },
  {
    ...
    zona: 'El Sunchal',
    foto_url: '/images/servicio-mecanico.png',
    ...ubicacion(5),
    activo: true,
  ...
  },
  {
    ...
    zona: 'Centro',
    foto_url: '/images/servicio-peluqueria.png',
    ...ubicacion(6),
    activo: true,
  ...
  // Genérico (sin negocio puntual confirmado todavía) — foto real de la
  // localidad, ubicado con offset cerca del centro como el resto.
  {
    id: 9,
    titulo: 'Reparación de celulares',
    subcategoria: 'Service técnico',
    descripcion: '',
    experiencia: '',
    whatsapp: '',
    telefono: '',
    horarios: '',
    zona: 'El Naranjo',
    foto_url: '/images/servicio-reparacion-celulares.png',
    ...ubicacion(23),
    activo: true,
    calificacion: calificacionDe([]),
  },
  {
    ...
    subcategoria: 'Tableros y automatización',
    descripcion: '',
    experiencia: '',
    whatsapp: '',
    telefono: '',
    horarios: '',
    zona: 'El Naranjo',
    foto_url: '/images/servicio-electricista-industrial.png',
    ...ubicacion(24),
    activo: true,
    calificacion: calificacionDe([]),
  },
  {
    id: 11,
    titulo: 'Corte de césped',
    subcategoria: 'Mantenimiento de jardines y terrenos',
    descripcion: '',
    experiencia: '',
    whatsapp: '',
    telefono: '',
    horarios: '',
    zona: 'El Naranjo',
    foto_url: '/images/servicio-cortador-cesped.png',
    ...ubicacion(25),
    activo: true,
    calificacion: calificacionDe([]),
  },
...
export const mockComercios = [
  {
    ...
    whatsapp: '3865124001',
    zona: 'Centro',
    logo_url: '/images/comercio-almacen.png',
    ...ubicacion(7),
    activo: true,
  ...
  },
  {
    ...
    whatsapp: '3865124002',
    zona: 'Centro',
    logo_url: '/images/comercio-panaderia.png',
    ...ubicacion(8),
    activo: true,
  ...
  },
  {
    ...
    whatsapp: '',
    zona: 'Barrio Matta',
    logo_url: '/images/comercio-carniceria.png',
    ...ubicacion(9),
    activo: true,
  ...
  },
  {
    ...
    whatsapp: '3865124004',
    zona: 'RP321',
    logo_url: '/images/comercio-ferreteria.png',
    ...ubicacion(10),
    activo: true,
  ...
  },
  {
    ...
    whatsapp: '3865124005',
    zona: 'Centro',
    logo_url: '/images/comercio-kiosco.png',
    ...ubicacion(11),
    activo: true,
  ...
  },
  {
    ...
    whatsapp: '3865124006',
    zona: 'Centro',
    logo_url: '/images/comercio-verduleria.png',
    ...ubicacion(12),
    activo: true,
