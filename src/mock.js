...
export const mockInstituciones = [
  {
    id: 1,
    tipo: 'escuela',
    nombre: 'Escuela N.º 12 Manuel Belgrano',
    descripcion: 'Nivel primario, turno mañana y tarde.',
    direccion: 'Calle Belgrano 55',
    telefono: '3865127001',
    horarios: 'Lunes a viernes, 8 a 17 hs',
    ...ubicacion(13),
    activo: true,
  },
  {
    id: 2,
    tipo: 'salud',
    nombre: 'Centro de Salud El Naranjo',
    descripcion: 'Atención primaria, vacunación y guardia de enfermería.',
    direccion: 'Av. San Martín 410',
    telefono: '3865127002',
    horarios: 'Lunes a viernes, 7 a 13 hs. Guardia todos los días',
    ...ubicacion(14),
    activo: true,
  },
  {
    id: 3,
    tipo: 'comuna',
    nombre: 'Comuna Rural El Naranjo',
    descripcion: 'Sede administrativa, trámites y atención al vecino.',
  ...
  },
  {
    id: 4,
    tipo: 'club',
    nombre: 'Club Atlético El Naranjo',
    descripcion: 'Fútbol infantil y de mayores, cancha de usos múltiples.',
    direccion: 'Camino a El Sunchal s/n',
    telefono: '',
    horarios: 'Entrenamientos martes y jueves, partidos domingo',
    ...ubicacion(16),
    activo: true,
  },
]
